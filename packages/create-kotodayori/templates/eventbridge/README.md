...
A Stripe webhook handler built with [Kotodayori](https://github.com/hideokamoto/stripe-webhook-router) and [AWS EventBridge](https://aws.amazon.com/eventbridge).
